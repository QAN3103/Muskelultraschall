"""
Script to Extract Image Features and Save to a CSV file 

This script is designed for the preprocessing and feature extraction of images, specifically for calculating various features such as histograms, 
Gray Level Co-occurrence Matrix (GLCM), and Gray Level Run Length Matrix (GLRLM) features. The script traverses the specified root directory to locate 
images using a list of Image IDs from a CSV file. It processes both 'bone' and 'muscle' images by reading, calculating features, and saving the 
extracted data into a new CSV file. This preprocessing step includes creating histograms, computing statistical properties, and extracting 
texture features using GLCM and GLRLM. The extracted features are used for subsequent analysis or machine learning applications.
...
Requirements: 
- Python 3.x
- Libraries: OpenCV (cv2), SciPy, Pandas, NumPy, scikit-image, Matplotlib, glrlm
"""
